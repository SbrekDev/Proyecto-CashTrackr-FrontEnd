	...
	return (
		<>
			...
			{budgets.length ? (
							...
							<div className="flex min-w-0 gap-x-4">
								<div className="min-w-0 flex-auto space-y-2">
									<p className="text-sm font-semibold leading-6 text-gray-900">
										<Link href={`/admin/budgets/${budget.id}`} className="cursor-pointer hover:underline text-xl font-bold">{budget.name}</Link>
									</p>
				...
				<p className="py-20 text-center">No hay Presupuestos Aún{' '} <Link className="text-purple-950 font-bold" href={'/admin/budgets/new'}>Comienza creando uno</Link></p>
			)}
		</>
	);
}
